...
One specific finding → exactly one ticket. Prerequisites are in `SKILL.md`; ticket format and creation rules are in `references/ticket-creation.md` — read that before the first draft.
